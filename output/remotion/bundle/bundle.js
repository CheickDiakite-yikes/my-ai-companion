...
/* unused harmony import specifier */ var measureSpring;
...
var WipePresentation = ({
  ...
  const [clipId] = (0,react.useState)(() => String((0,esm.random)(null)));
...
;// ./video/compositions/PromoOrbit45.tsx
...
const BRAND_ICON = (0,esm.staticFile)("icon-512.png");
const DISPLAY_FONT = '"Fraunces", "Iowan Old Style", "Times New Roman", serif';
const BODY_FONT = '"Sora", "Avenir Next", "Segoe UI", sans-serif';
const SCENE_DURATIONS = [120, 225, 240, 240, 240, 360];
const TRANSITION_FRAMES = 15;
const PROMO_DURATION_IN_FRAMES = SCENE_DURATIONS.reduce((sum, frames) => sum + frames, 0) - TRANSITION_FRAMES * (SCENE_DURATIONS.length - 1);
const TRANSITION_TIMING = linearTiming({ durationInFrames: TRANSITION_FRAMES });
const PALETTES = [
  {
    background: "linear-gradient(180deg, #060A15 0%, #040813 55%, #01040B 100%)",
  ...
  {
    background: "linear-gradient(180deg, #120A0D 0%, #180D12 46%, #09050A 100%)",
  ...
  {
    background: "linear-gradient(180deg, #07110F 0%, #0B1815 44%, #030807 100%)",
  ...
  {
    background: "linear-gradient(180deg, #08101C 0%, #0B1730 46%, #02060F 100%)",
  ...
  {
    background: "linear-gradient(180deg, #081116 0%, #0A1A20 50%, #020507 100%)",
  ...
  {
    background: "linear-gradient(180deg, #120A09 0%, #1B100D 45%, #090403 100%)",
...
const VOICE_METRICS = [
  ...
  { label: "Shared transcript", delay: 1 },
...
const springProgress = (frame, fps, delaySeconds, durationSeconds = 1.05) => {
  return (0,esm.spring)({
...
const easeProgress = (frame, fps, startSeconds, endSeconds) => {
...
const getLineGeometry = (startX, startY, endX, endY) => {
  ...
  return /* @__PURE__ */ react.createElement(
    esm.AbsoluteFill,
    {
      style: {
        mixBlendMode: "screen",
        opacity: 0.05,
        backgroundImage: "radial-gradient(circle at 20% 20%, rgba(255,255,255,0.55) 1px, transparent 1px), radial-gradient(circle at 80% 80%, rgba(255,255,255,0.35) 1px, transparent 1px)",
        backgroundSize: "8px 8px, 11px 11px"
      }
    }
  );
};
const Backdrop = ({ palette, sceneIndex }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(FrameNoise, null),
    /* @__PURE__ */ react.createElement(
      esm.AbsoluteFill,
      {
        style: {
          pointerEvents: "none",
          background: "radial-gradient(120% 90% at 50% 10%, rgba(255,255,255,0) 0%, rgba(0,0,0,0.28) 58%, rgba(0,0,0,0.72) 100%)"
        }
      }
    )
  );
};
const BrandChip = ({ palette, left = 90, top = 88 }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  ...
  return /* @__PURE__ */ react.createElement(
    "div",
    {
      style: {
        ...
        transform: `translateY(${(0,esm.interpolate)(inProgress, [0, 1], [20, 0])}px)`,
        opacity: inProgress
      }
    },
    /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(
      "div",
      {
        style: {
          ...
          color: palette.text,
          maxWidth: "100%",
          transform: `translateY(${(0,esm.interpolate)(titleIn, [0, 1], [50, 0])}px)`,
          opacity: titleIn,
    ...
    /* @__PURE__ */ react.createElement(
      "div",
      {
        style: {
          ...
          maxWidth: "100%",
          opacity: bodyIn,
          transform: `translateY(${(0,esm.interpolate)(bodyIn, [0, 1], [28, 0])}px)`
        }
      },
      body
    ),
    children ? /* @__PURE__ */ react.createElement(
      "div",
      {
        style: {
          marginTop: 26,
          opacity: bodyIn,
          transform: `translateY(${(0,esm.interpolate)(bodyIn, [0, 1], [24, 0])}px)`
        }
      },
      children
    ) : null
...
const FloatingChip = ({ palette, label, x, y, width, delay, rotate = 0 }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  ...
  return /* @__PURE__ */ react.createElement(
    "div",
    {
      style: {
        ...
        opacity: reveal,
        transform: `translate(${floatX}px, ${(0,esm.interpolate)(reveal, [0, 1], [36, 0]) + floatY}px) rotate(${rotate}deg)`
      }
    },
    label
  );
};
const OrbCluster = ({ palette, size, centerX, centerY, ribbonMode = false, iconMode = false }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    ribbonMode ? Array.from({ length: 3 }).map((_, index) => {
      ...
      return /* @__PURE__ */ react.createElement(
        "div",
        {
          ...
          style: {
            ...
            height: 14 + index * 6,
            borderRadius: 999,
            background: index % 2 === 0 ? `linear-gradient(90deg, rgba(0,0,0,0), ${palette.accentAlt}, rgba(0,0,0,0))` : `linear-gradient(90deg, rgba(0,0,0,0), ${palette.accent}, rgba(0,0,0,0))`,
    ...
    iconMode ? /* @__PURE__ */ react.createElement(
      "div",
      {
        style: {
          position: "absolute",
...
const GlassPanel = ({ palette, style, strong = false, children }) => {
  return /* @__PURE__ */ react.createElement(
    "div",
    {
      style: {
...
const PhoneShell = ({ palette, style, children }) => {
  const frame = (0,esm.useCurrentFrame)();
...
const VoiceBar = ({ palette, index }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const level = 0.35 + 0.65 * (0.5 + 0.5 * Math.sin(frame / (fps * 0.12) + index * 0.66));
  const height = (0,esm.interpolate)(level, [0, 1], [18, 122]);
  return /* @__PURE__ */ react.createElement(
    "div",
    {
      style: {
        ...
        height,
        borderRadius: 999,
        background: index % 3 === 0 ? `linear-gradient(180deg, ${palette.accentAlt}, rgba(255,255,255,0.16))` : `linear-gradient(180deg, ${palette.accent}, rgba(255,255,255,0.12))`,
        boxShadow: `0 0 18px ${index % 3 === 0 ? palette.accentAlt : palette.accent}`
      }
    }
  );
};
const VoiceScreen = ({ palette }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  ...
  return /* @__PURE__ */ react.createElement(
    esm.AbsoluteFill,
    {
      style: {
        ...
        background: "linear-gradient(180deg, rgba(11,15,24,1) 0%, rgba(14,26,40,1) 38%, rgba(8,11,16,1) 100%)"
      }
    },
    /* @__PURE__ */ react.createElement(
      "div",
    ...
    /* @__PURE__ */ react.createElement(
      ...
      Array.from({ length: 17 }).map((_, index) => /* @__PURE__ */ react.createElement(
        VoiceBar,
        {
          key: `voice-bar-${index}`,
          palette,
    ...
    /* @__PURE__ */ react.createElement(
      ...
      ["Mic", "Camera", "Thread"].map((label) => /* @__PURE__ */ react.createElement(
        GlassPanel,
        {
          key: label,
          palette,
...
const ChatBubble = ({ palette, text, side, top, delay, width }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const reveal = springProgress(frame, fps, delay, 0.82);
  const xOffset = (0,esm.interpolate)(reveal, [0, 1], [side === "left" ? -34 : 34, 0]);
  return /* @__PURE__ */ react.createElement(
    "div",
    {
      style: {
        ...
        padding: "18px 20px",
        borderRadius: 28,
        background: side === "left" ? "rgba(255,255,255,0.1)" : `linear-gradient(135deg, ${palette.accentAlt}, ${palette.accent})`,
        color: side === "left" ? palette.text : "#0C1115",
        border: side === "left" ? `1px solid ${palette.border}` : "1px solid rgba(255,255,255,0.16)",
        fontFamily: BODY_FONT,
        fontSize: 24,
        lineHeight: 1.25,
        fontWeight: 500,
...
const ChatScreen = ({ palette }) => {
  return /* @__PURE__ */ react.createElement(
    esm.AbsoluteFill,
    {
      style: {
        padding: "28px 24px 26px",
        background: "linear-gradient(180deg, rgba(23,14,11,1) 0%, rgba(28,17,14,1) 46%, rgba(14,9,8,1) 100%)"
      }
    },
    /* @__PURE__ */ react.createElement(
      "div",
    ...
    /* @__PURE__ */ react.createElement(
      ...
      ["Memory", "Tone", "Context"].map((label) => /* @__PURE__ */ react.createElement(
        GlassPanel,
        {
          key: label,
          palette,
...
const ConnectorLine = ({ palette, startX, startY, endX, endY, delay }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
...
const MemoryCard = ({ palette, title, body, x, y, delay }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const reveal = springProgress(frame, fps, delay, 0.95);
  ...
  return /* @__PURE__ */ react.createElement(
    GlassPanel,
    {
      ...
      style: {
        ...
        padding: "26px 28px",
        opacity: reveal,
        transform: `translateY(${(0,esm.interpolate)(reveal, [0, 1], [32, 0]) + hover}px)`
      }
    },
    /* @__PURE__ */ react.createElement(
      "div",
...
const CameraScreen = ({ palette }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const scanY = (0,esm.interpolate)(
  ...
  return /* @__PURE__ */ react.createElement(
    esm.AbsoluteFill,
    {
      style: {
        ...
        background: "linear-gradient(180deg, rgba(6,12,20,1) 0%, rgba(10,20,38,1) 42%, rgba(4,8,15,1) 100%)"
      }
    },
    /* @__PURE__ */ react.createElement(
      "div",
    ...
    /* @__PURE__ */ react.createElement(
      "div",
      {
        style: {
          ...
          borderRadius: 36,
          overflow: "hidden",
          background: "linear-gradient(180deg, rgba(31,71,114,0.86) 0%, rgba(45,70,88,0.76) 26%, rgba(115,79,49,0.88) 100%)"
        }
      },
      /* @__PURE__ */ react.createElement(
        "div",
        {
          style: {
            position: "absolute",
            inset: 0,
            background: "radial-gradient(circle at 32% 30%, rgba(255,255,255,0.24) 0%, rgba(255,255,255,0) 32%), radial-gradient(circle at 64% 64%, rgba(255,204,145,0.3) 0%, rgba(255,255,255,0) 36%)"
          }
        }
      ),
      /* @__PURE__ */ react.createElement(
        "div",
        {
          style: {
            ...
            height: 420,
            borderRadius: 120,
            background: "linear-gradient(180deg, rgba(17,36,46,0.28) 0%, rgba(15,24,33,0.58) 100%)",
            filter: "blur(1px)",
      ...
      /* @__PURE__ */ react.createElement(
        "div",
        {
          style: {
            ...
            height: 240,
            borderRadius: 58,
            background: "linear-gradient(180deg, rgba(255,232,176,0.7) 0%, rgba(165,112,70,0.5) 100%)",
            filter: "blur(0.6px)",
      ...
      [
        ...
        { left: 60, bottom: 140 },
        { right: 60, bottom: 140 }
      ].map((corner, index) => /* @__PURE__ */ react.createElement(
        "div",
        {
          key: `focus-${index}`,
          style: {
            ...
            borderStyle: "solid",
            borderTopWidth: corner.top !== void 0 ? 4 : 0,
            borderLeftWidth: corner.left !== void 0 ? 4 : 0,
            borderRightWidth: corner.right !== void 0 ? 4 : 0,
            borderBottomWidth: corner.bottom !== void 0 ? 4 : 0,
            borderRadius: 20,
            opacity: 0.75,
            ...corner
          }
...
const AnalysisCard = ({ palette, x, y, title, body, delay }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  ...
  return /* @__PURE__ */ react.createElement(
    GlassPanel,
    {
      ...
      style: {
        ...
        padding: "20px 22px",
        opacity: reveal,
        transform: `translateY(${(0,esm.interpolate)(reveal, [0, 1], [30, 0]) + wobble}px)`
      }
    },
    /* @__PURE__ */ react.createElement(
      "div",
...
const ContextBoard = ({ palette }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(
      ...
      ["Web", "Mail", "Calendar", "Markets"].map((label) => /* @__PURE__ */ react.createElement(
        GlassPanel,
        {
          key: label,
          palette,
...
const ProfileScreen = ({ palette }) => {
  return /* @__PURE__ */ react.createElement(
    esm.AbsoluteFill,
    {
      style: {
        padding: "28px 24px 24px",
        background: "linear-gradient(180deg, rgba(30,18,14,1) 0%, rgba(42,24,18,1) 42%, rgba(20,11,9,1) 100%)"
      }
    },
    /* @__PURE__ */ react.createElement(
      "div",
...
const HookScene = () => {
  ...
  return /* @__PURE__ */ react.createElement(esm.AbsoluteFill, null, /* @__PURE__ */ react.createElement(Backdrop, { palette, sceneIndex: 0 }), /* @__PURE__ */ react.createElement(BrandChip, { palette }), /* @__PURE__ */ react.createElement(
    OrbCluster,
    {
      palette,
      size: 640,
  ...
  ), HOOK_CHIPS.map((chip) => /* @__PURE__ */ react.createElement(
    FloatingChip,
    {
      key: chip.label,
      palette,
    ...
    CopyBlock,
    {
      ...
      title: /* @__PURE__ */ react.createElement(react.Fragment, null, "Meet Zee.", /* @__PURE__ */ react.createElement("br", null), "Presence with memory."),
    ...
    /* @__PURE__ */ react.createElement(
      ...
      ["Ideas", "Feelings", "Questions", "Creative sparks"].map((item) => /* @__PURE__ */ react.createElement(
        GlassPanel,
        {
          key: item,
          palette,
...
const VoiceThreadScene = () => {
  const palette = PALETTES[1];
  return /* @__PURE__ */ react.createElement(esm.AbsoluteFill, null, /* @__PURE__ */ react.createElement(Backdrop, { palette, sceneIndex: 1 }), /* @__PURE__ */ react.createElement(BrandChip, { palette }), /* @__PURE__ */ react.createElement(
    CopyBlock,
    {
      palette,
      eyebrow: "VOICE + TEXT",
      title: /* @__PURE__ */ react.createElement(react.Fragment, null, "Talk naturally.", /* @__PURE__ */ react.createElement("br", null), "Text seamlessly."),
    ...
    /* @__PURE__ */ react.createElement(
      ...
      VOICE_METRICS.map((metric) => /* @__PURE__ */ react.createElement(
        GlassPanel,
        {
          key: metric.label,
          palette,
    ...
    /* @__PURE__ */ react.createElement(ChatScreen, { palette })
  ), /* @__PURE__ */ react.createElement(
    PhoneShell,
    {
      palette,
    ...
    /* @__PURE__ */ react.createElement(VoiceScreen, { palette })
  ));
};
const MemoryScene = () => {
  ...
  const hubX = 532;
  const hubY = 664;
  return /* @__PURE__ */ react.createElement(esm.AbsoluteFill, null, /* @__PURE__ */ react.createElement(Backdrop, { palette, sceneIndex: 2 }), /* @__PURE__ */ react.createElement(BrandChip, { palette }), /* @__PURE__ */ react.createElement(
    CopyBlock,
    {
      palette,
      eyebrow: "CONTINUITY",
      title: /* @__PURE__ */ react.createElement(react.Fragment, null, "It remembers", /* @__PURE__ */ react.createElement("br", null), "what matters."),
  ...
  ), MEMORY_ITEMS.map((item) => /* @__PURE__ */ react.createElement(
    MemoryCard,
    {
      key: item.title,
      palette,
  ...
  )), MEMORY_ITEMS.map((item, index) => /* @__PURE__ */ react.createElement(
    ConnectorLine,
    {
      key: `line-${item.title}`,
      palette,
...
const VisionScene = () => {
  ...
  return /* @__PURE__ */ react.createElement(esm.AbsoluteFill, null, /* @__PURE__ */ react.createElement(Backdrop, { palette, sceneIndex: 3 }), /* @__PURE__ */ react.createElement(BrandChip, { palette }), /* @__PURE__ */ react.createElement(
    CopyBlock,
    {
      palette,
      eyebrow: "VISION",
      title: /* @__PURE__ */ react.createElement(react.Fragment, null, "Show Zee", /* @__PURE__ */ react.createElement("br", null), "what you see."),
    ...
    /* @__PURE__ */ react.createElement(CameraScreen, { palette })
  ), VISION_TAGS.map((tag) => /* @__PURE__ */ react.createElement(
    FloatingChip,
    {
      key: tag.label,
      palette,
...
const ContextScene = () => {
  ...
  return /* @__PURE__ */ react.createElement(esm.AbsoluteFill, null, /* @__PURE__ */ react.createElement(Backdrop, { palette, sceneIndex: 4 }), /* @__PURE__ */ react.createElement(BrandChip, { palette }), /* @__PURE__ */ react.createElement(ContextBoard, { palette }), /* @__PURE__ */ react.createElement(
    CopyBlock,
    {
      palette,
      eyebrow: "CONTEXT",
      title: /* @__PURE__ */ react.createElement(react.Fragment, null, "Grounded in", /* @__PURE__ */ react.createElement("br", null), "your world."),
    ...
    /* @__PURE__ */ react.createElement(
      ...
      ["Morning Brief", "Gmail", "Calendar", "Latest info"].map((label) => /* @__PURE__ */ react.createElement(
        GlassPanel,
        {
          key: label,
          palette,
...
const FinalScene = ({ userName }) => {
  const palette = PALETTES[5];
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const stageAOut = 1 - easeProgress(frame, fps, 4.6, 5.6);
  const stageBIn = easeProgress(frame, fps, 4.9, 6.1);
  const userLine = userName && userName.trim() && userName !== "Friend" ? `Built for ${userName}.` : "Built for you.";
  return /* @__PURE__ */ react.createElement(esm.AbsoluteFill, null, /* @__PURE__ */ react.createElement(Backdrop, { palette, sceneIndex: 5 }), /* @__PURE__ */ react.createElement(BrandChip, { palette }), /* @__PURE__ */ react.createElement(
    "div",
    {
      style: {
        opacity: stageAOut
    ...
    /* @__PURE__ */ react.createElement(
      CopyBlock,
      {
        ...
        title: /* @__PURE__ */ react.createElement(react.Fragment, null, "Choose the voice.", /* @__PURE__ */ react.createElement("br", null), "Shape the tone."),
    ...
    PERSONALIZATION_TAGS.map((tag) => /* @__PURE__ */ react.createElement(
      FloatingChip,
      {
        key: tag.label,
        palette,
    ...
    /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(ProfileScreen, { palette })
    ),
    /* @__PURE__ */ react.createElement(
      PhoneShell,
      {
    ...
    "div",
    {
      style: {
        ...
        inset: 0,
        opacity: stageBIn,
        transform: `scale(${(0,esm.interpolate)(stageBIn, [0, 1], [0.95, 1])})`
      }
    },
    /* @__PURE__ */ react.createElement(
      OrbCluster,
    ...
    /* @__PURE__ */ react.createElement(
      CopyBlock,
      {
        palette,
        eyebrow: "ZEE / ZEE ME",
        title: /* @__PURE__ */ react.createElement(react.Fragment, null, "Talk. Show.", /* @__PURE__ */ react.createElement("br", null), "Remember."),
...
const PromoOrbit45 = ({ userName }) => {
  return /* @__PURE__ */ react.createElement(esm.AbsoluteFill, { style: { WebkitFontSmoothing: "antialiased" } }, /* @__PURE__ */ react.createElement(TransitionSeries, null, /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: SCENE_DURATIONS[0] }, /* @__PURE__ */ react.createElement(HookScene, null)), /* @__PURE__ */ react.createElement(TransitionSeries.Transition, { presentation: fade(), timing: TRANSITION_TIMING }), /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: SCENE_DURATIONS[1] }, /* @__PURE__ */ react.createElement(VoiceThreadScene, null)), /* @__PURE__ */ react.createElement(
    TransitionSeries.Transition,
    {
      presentation: slide_slide({ direction: "from-right" }),
      timing: TRANSITION_TIMING
    }
  ), /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: SCENE_DURATIONS[2] }, /* @__PURE__ */ react.createElement(MemoryScene, null)), /* @__PURE__ */ react.createElement(
    TransitionSeries.Transition,
    {
      presentation: wipe({ direction: "from-bottom" }),
      timing: TRANSITION_TIMING
    }
  ), /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: SCENE_DURATIONS[3] }, /* @__PURE__ */ react.createElement(VisionScene, null)), /* @__PURE__ */ react.createElement(TransitionSeries.Transition, { presentation: fade(), timing: TRANSITION_TIMING }), /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: SCENE_DURATIONS[4] }, /* @__PURE__ */ react.createElement(ContextScene, null)), /* @__PURE__ */ react.createElement(
    TransitionSeries.Transition,
    {
      presentation: slide_slide({ direction: "from-top" }),
      timing: TRANSITION_TIMING
    }
  ), /* @__PURE__ */ react.createElement(TransitionSeries.Sequence, { durationInFrames: SCENE_DURATIONS[5] }, /* @__PURE__ */ react.createElement(FinalScene, { userName }))));
};
...
const RemotionRoot = () => {
  return /* @__PURE__ */ React.createElement(esm.Folder, { name: "ZeeMe-Promo" }, /* @__PURE__ */ React.createElement(
    esm.Composition,
    {
      id: "PromoOrbit45",
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "rest-express:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkrest_express"] = self["webpackChunkrest_express"] || [];
